...
var cardsProducts = document.querySelectorAll(".card-product-v1");
if(alerts) {
...
if(cardsProducts){
    cardsProducts.forEach(card => {
        var prodcutPictures = card.querySelectorAll(".card-product-others-image-list li");
        var productImageareadisplay = card.querySelector(".card-product-image-section img");
    ...
    if (this.innerWidth > 768) {
        cardsProducts.forEach(card => {
            var containerForZoom = card.querySelector(".card-product-image-container");
            var currentDisplayedImage = card.querySelector(".card-product-image-section");
            var currentDisplayedImageCli = currentDisplayedImage.getBoundingClientRect();
